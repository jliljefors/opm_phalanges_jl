...
for i_sub = 2:size(subses,1)
    ...
    if exist(fullfile(save_path, 'mne_fits.mat'),'file') && overwrite.mne==false
        ...
        [megmag_mne, megplanaer_mne, opm_mne, eeg_mne, FAHM] = fit_mne(save_path,megmag_timelocked,megplanar_timelocked,megeeg_timelocked,opm_timelockedT,opmeeg_timelockedT,headmodels,sourcemodelT,m100_latency,params);
    end
end
close all
