...
for i_phalange = 1:5
    ...
    title(['SQUID-MAG (FAHM=' num2str(squidmag_mne.avg{i_phalange}.fahm,3) ')'])
...
for i_phalange = 1:5
    ...
    h = figure;
    ft_sourceplot(cfg, tmp)
    title(['SQUID-GRAD (FAHM=' num2str(squidgrad_mne.avg{i_phalange}.fahm,3) ')'])
...
for i_phalange = 1:5
    ...
    if ~isempty(headmodels.headmodel_eeg)
        ...
        h = figure;
        ft_sourceplot(cfg, tmp)
        title(['SQUID-EEG (FAHM=' num2str(squideeg_mne.avg{i_phalange}.fahm,3) ')'])
