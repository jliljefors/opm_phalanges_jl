function [headmodels, meshes, mri_resliced_cm] = prepare_mri(mri_file,meg_file,aux_file,save_path)
...
%     mri_resliced_cm = ft_convert_units(mri_resliced, 'cm');
    ...
    save(fullfile(save_path, 'mri_resliced_cm.mat'), 'mri_resliced_cm'); disp('done')
